package ai.gollek.peutui.core.autocomplete;
...
public interface AutocompleteProvider {
    ...
    /** Characters that should naturally trigger this provider at a token boundary (e.g. {@code '/'}, {@code '@'}). */
     ...
     */
    CompletableFuture<AutocompleteSuggestions> getSuggestions(List<String> lines, int cursorLine, int cursorCol, boolean force);

    /** Applies a chosen suggestion, producing the new buffer state. */
    CompletionEdit applyCompletion(List<String> lines, int cursorLine, int cursorCol, AutocompleteItem item, String prefix);

    /** Whether explicit Tab-completion should be attempted by this provider at the current position. */
