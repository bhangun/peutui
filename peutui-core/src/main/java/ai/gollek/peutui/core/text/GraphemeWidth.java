 ...
 *
 * <p>Mirrors the behavior expected by a monospace terminal renderer: most
...
public final class GraphemeWidth {
    ...
    /** Segments {@code text} into grapheme clusters using the default locale's rules. */
    ...
    /** Total visible column width of the whole string, ignoring ANSI codes (use {@link TextMeasure} for that). */
