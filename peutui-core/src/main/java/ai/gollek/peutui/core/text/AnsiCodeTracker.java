 ...
 *
 * <p>This is intentionally a simple last-write-wins model keyed by SGR
...
public final class AnsiCodeTracker {
    ...
    /** Feed a single CSI/SGR escape sequence (e.g. {@code "\u001b[1m"}) into the tracker. */
    ...
    /** Returns the concatenation of all currently active SGR codes, in insertion order. */
