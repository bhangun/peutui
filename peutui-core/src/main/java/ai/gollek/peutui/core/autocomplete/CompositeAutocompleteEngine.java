...
public final class CompositeAutocompleteEngine {
    ...
    public CompletableFuture<AutocompleteSuggestions> getSuggestions(List<String> lines, int cursorLine, int cursorCol, boolean force) {
    ...
    private CompletableFuture<AutocompleteSuggestions> resolveInOrder(
            java.util.Iterator<AutocompleteProvider> iterator, List<String> lines, int cursorLine, int cursorCol, boolean force) {
        if (!iterator.hasNext()) {
