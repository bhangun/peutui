...
public sealed interface AgentEvent {
    ...
    record ToolCallStarted(String agentId, String toolName, String toolCallId, String argumentsJson) implements AgentEvent {
    }

    record ToolCallCompleted(String agentId, String toolCallId, String resultJson, boolean isError) implements AgentEvent {
    }
