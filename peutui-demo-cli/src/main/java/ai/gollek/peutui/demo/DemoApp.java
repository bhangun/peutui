package ai.gollek.peutui.demo;

import ai.gollek.peutui.agent.AgentContext;
import ai.gollek.peutui.agent.AgentEvent;
import ai.gollek.peutui.agent.AgentMessage;
import ai.gollek.peutui.agent.AgentOrchestrationStrategy;
import ai.gollek.peutui.core.autocomplete.AutocompleteItem;
import ai.gollek.peutui.core.autocomplete.AutocompleteProvider;
import ai.gollek.peutui.core.autocomplete.AutocompleteSuggestions;
import ai.gollek.peutui.core.autocomplete.CompletionEdit;
import ai.gollek.peutui.core.autocomplete.CompositeAutocompleteEngine;
import ai.gollek.peutui.project.ProjectRegistry;
import ai.gollek.peutui.provider.ProviderRegistry;
import ai.gollek.peutui.provider.ProviderSelectionStrategy;
...
import ai.gollek.peutui.widgets.App;
import ai.gollek.peutui.widgets.ChatHistoryComponent;
import ai.gollek.peutui.widgets.SpinnerComponent;
import ai.gollek.peutui.widgets.StatusBarComponent;
import ai.gollek.peutui.widgets.TextInputComponent;
import ai.gollek.peutui.widgets.VerticalStackComponent;
 ...
 *
 * <p>Improvements over the baseline demo:
 * <ul>
...
public final class DemoApp implements QuarkusApplication {
    ...
    public int run(String... args) throws Exception {
        ...
        // Stack: flexible history | 1-row spinner (hidden when idle) | 1-row status | 3-row input
    ...
    private String resolveProviderId() {
        try {
            var dummyRequest = new ai.gollek.peutui.provider.ProviderRequest("", List.of());
