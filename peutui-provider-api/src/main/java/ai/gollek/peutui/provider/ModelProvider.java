...
public interface ModelProvider {
    ...
    /** Streams a chat completion; the returned publisher emits zero or more deltas followed by one Done/Error. */
    Flow.Publisher<ProviderEvent> streamChat(ProviderRequest request);

    /** Whether this provider is currently reachable/configured (used by failover strategies). */
