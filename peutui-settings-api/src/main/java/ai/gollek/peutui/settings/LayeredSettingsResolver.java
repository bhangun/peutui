package ai.gollek.peutui.settings;
...
public final class LayeredSettingsResolver {
    ...
    /** Resolves the effective value of {@code key}, checking scopes from highest to lowest precedence. */
    ...
    /** Returns the effective value for every key visible from any applicable scope, already merged by precedence. */
