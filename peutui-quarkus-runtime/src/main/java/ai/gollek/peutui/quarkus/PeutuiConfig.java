...
public interface PeutuiConfig {
    ...
    interface StorageConfig {
        ...
        enum Mode {
            @WithName("local-file") LOCAL_FILE,
            @WithName("local-database") LOCAL_DATABASE,
            @WithName("cloud") CLOUD
        }
    ...
    interface ProviderConfig {
        ...
        enum Selection {
            @WithName("single") SINGLE,
            @WithName("round-robin") ROUND_ROBIN,
            @WithName("failover") FAILOVER
        }
    }
}
