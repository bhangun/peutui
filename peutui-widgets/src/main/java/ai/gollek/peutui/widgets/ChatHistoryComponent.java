...
import ai.gollek.peutui.agent.MessageRole;
...
public final class ChatHistoryComponent implements Component {
    ...
    /** Replaces the most recently appended message, used to render incremental streaming updates in place. */
    ...
    private String roleTag(AgentMessage message) {
        String base = switch (message.role()) {
            ...
            case ASSISTANT -> AnsiCodes.BOLD + (showAgentTags && message.agentId() != null ? message.agentId() : "assistant") + AnsiCodes.RESET;
