...
import ai.gollek.peutui.core.text.TextMeasure;
import ai.gollek.peutui.core.text.WordNavigation;
 ...
 * a distinct key) can be wired to insert a newline via {@link #insertNewline()}.
 */
public final class TextInputComponent implements Component {
    ...
    private void renderSuggestionPopup(RenderContext context) {
        ...
        for (int i = 0; i < maxItems; i++) {
            ...
            String label = " " + item.label() + (item.description() != null ? "  " + AnsiCodes.DIM + item.description() + AnsiCodes.RESET : "");
